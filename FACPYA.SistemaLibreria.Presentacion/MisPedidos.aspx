<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MisPedidos.aspx.cs" Inherits="FACPYA.SistemaLibreria.Presentacion.MisPedidos" %>
...
<body class="bg-light letra ">
    ...
    <main class="row container-fluid">
        ...
        <div class="col-sm-12 col-xl-5 m-3 ">
            ...
            <h5 class="text-start">Todos los pedidos</h5>

            <!-- CONTENEDOR PRODUCTO VENTA -->
            <div>
        ...
        <div class="col-sm-12 col-xl-4 d-flex justify-content-center align-items-center">
            <div class="">
                <img src="/static/img/pedidos.png" class="w-100 h-100 " alt="Bootstrap">
            </div>
        </div>
    </main>
