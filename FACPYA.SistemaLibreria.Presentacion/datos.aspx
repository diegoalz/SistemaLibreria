                    ...
                    <div class="">
                        <div class="container-fluid">
                            <div class="navbar-brand text-center mb-3">
                                <img src="/static/img/estatus0.png"  class="w-50" alt="Bootstrap" width="" height="">
                            </div>
                ...
                <div class="col-xl-4 col-sm-12 text-center m-2">
                    ...
                    <div class="col-xl-12 col-sm-12 text-center ">
                        <div class="d-none d-sm-none d-xl-block ">
                            ...
                            <a  href="/carro_compras.html" class="btn btn-secondary w-100 boton cinco">
                                <div class="icono">
                ...
                <div class="col-xl-4 col-sm-12 text-center m-2">
                    <div class="col-xl-12 col-sm-12 text-center ">
                        <div class="d-none d-sm-none d-xl-block ">
                            ...
                            <a  href="/envio.html" class="btn btn-danger w-100 boton cinco">
                                <div class="icono">
                ...
                <div class="col-xl-4 col-sm-12 text-center m-2">
                    ...
                    <div class="d-block d-sm-block  d-md-block d-xl-none ">
                        <div class="col-xl-4 col-sm-12 text-center ">
                            ...
                            <a href="/carro_compras.html" class="btn btn-secondary w-100"> <i class="bi bi-arrow-left"></i> ATRAS  </a>
                        </div>
                ...
                <div class="col-xl-4 col-sm-12 text-center m-2">
                    ...
                    <div class="d-block d-sm-block  d-md-block d-xl-none ">
                        <div class="col-xl-4 col-sm-12 text-center ">
                            ...
                            <a href="/envio.html" class="btn btn-danger w-100">CONTINUAR  <i class="bi bi-arrow-right"></i></a>
                        </div>
