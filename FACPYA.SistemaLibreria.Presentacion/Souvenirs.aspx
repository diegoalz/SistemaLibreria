<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Souvenirs.aspx.cs" Inherits="FACPYA.SistemaLibreria.Presentacion.Souvenirs" %>
                                        ...
                                        <div class="card card-flyer">
                                            ...
                                            <div class="card-body">
                                                <div class="text-reset">
                                                    <h5 class="card-title mb-3">TAZA FACPYANA</h5>
                                                </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-4 ">
                                        <div class="card card-flyer">
                                            <div class="bg-image hover-zoom ripple ripple-surface ripple-surface-light"
                                                data-mdb-ripple-color="light">
                                                <img style="height: 20em;"
                                                    src="/static/img/yuki_facpya.JPG"
                                                    class="w-100" />
                                                <a href="/producto_detalle.html">
                                                    <div class="mask">
                                                        <div class="d-flex justify-content-end align-items-end h-100">
                                            ...
                                            <div class="card-body">
                                                <div class="text-reset">
                                                    <h5 class="card-title mb-3">Termo Facpyano</h5>
                                                </div>
                                                <div class="text-reset">
                                                    <p>Desripcion</p>
                                                </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-4 ">
                                        <div class="card card-flyer">
                                            <div class="bg-image hover-zoom ripple" data-mdb-ripple-color="light">
                                                <img style="height: 20em;"
                                                    src="/static/img/termo_facpya.JPG"
                                                    class="w-100" />
                                                <a href="/producto_detalle.html">
                                                    <div class="mask">
                                                        <div class="d-flex justify-content-end align-items-end h-100">
                                            ...
                                            <div class="card-body">
                                                <div class="text-reset">
                                                    <h5 class="card-title mb-3">TERMO FACPYA</h5>
                                                </div>
                                                <div class="text-reset">
                                                    <p>Descripcion</p>
                                                </div>
